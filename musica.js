...
const cancionesData = [
    ...
    { archivo: 'musica/Apocalypse - Is This Love.mp3', favorita: true },
    { archivo: 'musica/Apocalypse - Cigarettes After Sex.mp3', favorita: true },
    { archivo: 'musica/Billie Eilish - BLUE.mp3', favorita: true },
    { archivo: 'musica/Billie Eilish - WILDFLOWER.mp3', favorita: true },
    { archivo: 'musica/Camila Cabello - This Love.mp3', favorita: true },
    { archivo: 'musica/Dont Blame Me.mp3', favorita: true },
    { archivo: 'musica/Just A Little Bit Of Your Heart.mp3', favorita: true },
    { archivo: 'musica/K. - Cigarettes After Sex.mp3', favorita: true },
    { archivo: 'musica/Leave Me Lonely.mp3', favorita: true },
    { archivo: 'musica/LP - Strange.mp3', favorita: true },
    { archivo: 'musica/Next To Me - Imagine Dragons.mp3', favorita: true },
    { archivo: 'musica/Olivia Rodrigo - get him back!.mp3', favorita: true },
    { archivo: 'musica/Olivia Rodrigo - honeybee.mp3', favorita: true },
    { archivo: 'musica/Olivia Rodrigo - jealousy, jealousy.mp3', favorita: true },
    { archivo: 'musica/One Direction - If I Could Fly.mp3', favorita: true },
    { archivo: 'musica/Sabrina Carpenter - Sugar Talking.mp3', favorita: true },
    { archivo: 'musica/Sam Smith - Fire On Fire.mp3', favorita: true },
    { archivo: 'musica/Seafret - Atlantis.mp3', favorita: true },
    { archivo: 'musica/Selena Gomez, benny blanco - How Does It Feel To Be Forgot.mp3', favorita: true },
    { archivo: 'musica/STARSEEDZ - SUBLIME.mp3', favorita: true },
    { archivo: 'musica/Taylor Swift - Anti-Hero.mp3', favorita: true },
    { archivo: 'musica/Taylor Swift - Karma.mp3', favorita: true },
    { archivo: 'musica/Tomorrow Never Came -Lana Del Rey.mp3', favorita: true },
    { archivo: 'musica/Touch It.mp3', favorita: true },
    { archivo: 'musica/ZAYN - Good Years.mp3', favorita: true },
    { archivo: 'musica/ZAYN - PILLOWTALK.mp3', favorita: true },
    ...
    { archivo: 'musica/Conan Gray - Memories (Lyrics).mp3', favorita: true },
    { archivo: 'musica/Eminem - Superman (Audio).mp3', favorita: true },
    ...
    { archivo: 'musica/Keane - Somewhere Only We Know.mp3', favorita: false },
    ...
    { archivo: 'musica/Lana Del Rey - Summertime Sadness.mp3', favorita: false },
    ...
    { archivo: "musica/Taylor Swift - The Fate of Ophelia.mp3", favorita: false },
    ...
    { archivo: 'musica/Billie Eilish - CHIHIRO.mp3', favorita: false },
    { archivo: 'musica/Billie Eilish - WILDFLOWER.mp3', favorita: false },
    ...
    { archivo: "musica/Ariana Grande - no tears left to cry.mp3", favorita: false },
    { archivo: "musica/Ariana Grande - we can't be friends.mp3", favorita: false },
    { archivo: 'musica/The Weeknd, Ariana Grande - Die For You.mp3', favorita: true },
    { archivo: 'musica/The Weeknd, JENNIE & Lily Rose Depp - One Of The Girls.mp3', favorita: false },
    { archivo: 'musica/Doja Cat, The Weeknd - You Right.mp3', favorita: false },
    { archivo: 'musica/Selena Gomez - Fetish ft. Gucci Mane.mp3', favorita: false },
    { archivo: 'musica/Dove Cameron - Boyfriend.mp3', favorita: false },
    { archivo: 'musica/RIDE OR DIE PT. 2 FT. TOKISCHA & VILLANO ANTILLANO.mp3', favorita: false },
    { archivo: 'musica/Dracula.mp3', favorita: false },
    ...
    { archivo: 'musica/Dua Lipa - Break My Heart.mp3', favorita: false },
    { archivo: 'musica/Camila Cabello - Shameless.mp3', favorita: false },
    ...
    { archivo: 'musica/Ariana Grande ft. Nicki Minaj - Side To Side ft. Nicki Minaj.mp3', favorita: false },
    { archivo: 'musica/Ariana Grande - 7 rings.mp3', favorita: false },
    { archivo: 'musica/Justin Bieber - Beauty And A Beat ft. Nicki Minaj.mp3', favorita: false },
    { archivo: 'musica/Robin Schulz - Sugar.mp3', favorita: false },
    { archivo: 'musica/5 Seconds of Summer - Youngblood.mp3', favorita: false },
    { archivo: 'musica/5 Seconds of Summer - Teeth.mp3', favorita: false },
    { archivo: 'musica/The Wanted - Glad You Came.mp3', favorita: false },
    { archivo: 'musica/DNCE - Cake By The Ocean.mp3', favorita: false },
    { archivo: 'musica/LET THE WORLD BURN.mp3', favorita: false },
    { archivo: "musica/Lady Gaga, Doechii - RUNWAY.mp3", favorita: false },
    { archivo: "musica/Lady Gaga - Abracadabra.mp3", favorita: false },
    { archivo: 'musica/ROSÉ - \'On The Ground\'.mp3', favorita: true },
    { archivo: 'musica/Camila Cabello - My Oh My.mp3', favorita: true },
    { archivo: 'musica/LISA - MOONLIT FLOOR.mp3', favorita: true },
    ...
    { archivo: "musica/Bruno Mars - Thats What I Like.mp3", favorita: false },
    { archivo: 'musica/Maroon 5 - Sugar.mp3', favorita: false },

    // ── Big Time Rush / pop juvenil 2010s ────────────────────────────
    { archivo: 'musica/Big Time Rush - Confetti Falling.mp3', favorita: false },
    { archivo: 'musica/Big Time Rush - City Is Ours.mp3', favorita: false },
    { archivo: 'musica/Big Time Rush - Big Night.mp3', favorita: false },
    { archivo: 'musica/Big Time Rush - Til I Forget About You.mp3', favorita: false },
    { archivo: 'musica/Big Time Rush - Any Kind of Guy.mp3', favorita: false },
    { archivo: 'musica/Big Time Rush - Music Sounds Better ft. Mann.mp3', favorita: false },
    { archivo: 'musica/Big Time Rush - Worldwide.mp3', favorita: false },
    { archivo: 'musica/Big Time Rush - Boyfriend ft. Snoop Dogg.mp3', favorita: false },
    { archivo: 'musica/Big Time Rush - Windows Down.mp3', favorita: false },
    ...
    { archivo: 'musica/Michael Jackson - Human Nature.mp3', favorita: false },
    { archivo: "musica/Michael Jackson - Don't Stop 'Til You Get Enough.mp3", favorita: false },
    { archivo: 'musica/Beat It.mp3', favorita: false },
    { archivo: 'musica/You Rock My World.mp3', favorita: false },
    ...
    { archivo: 'musica/Sweet Dreams.mp3', favorita: false },
    ...
    // ── Recién añadidas ────────────────────────────────────────────────
    { archivo: 'musica/Camila Cabello - Shameless.mp3', favorita: false },
    { archivo: 'musica/Billie Eilish - LAMOUR DE MA VIE.mp3', favorita: false },
    { archivo: 'musica/Seafret - Atlantis.mp3', favorita: false },
    { archivo: 'musica/Taylor Swift - Call It What You Want.mp3', favorita: false },
    { archivo: 'musica/Cinnamon Girl.mp3', favorita: false },
    { archivo: 'musica/Camila Cabello - Easy.mp3', favorita: false },
    { archivo: 'musica/Why Try.mp3', favorita: false },
    { archivo: 'musica/Sam Smith - Unholy ft. Kim Petras.mp3', favorita: false },
    { archivo: 'musica/Taylor Swift - right where you left me.mp3', favorita: false },
    { archivo: 'musica/Lana Del Rey - Young and Beautiful.mp3', favorita: false },
    { archivo: 'musica/Ghost of you  5sos  Sub españolinglés.mp3', favorita: false },
    { archivo: 'musica/Harry Styles - Little Freak.mp3', favorita: false },
    { archivo: 'musica/Camila Cabello - Bam Bam ft. Ed Sheeran.mp3', favorita: false },
    { archivo: 'musica/3435.mp3', favorita: false },
    { archivo: 'musica/Taylor Swift - Snow On The Beach ft. Lana Del Rey.mp3', favorita: false },
    { archivo: 'musica/Olivia Rodrigo - hope ur ok.mp3', favorita: false },
    { archivo: 'musica/ZAYN - fOoL fOr YoU.mp3', favorita: false },
    { archivo: 'musica/Ariana Grande - NASA.mp3', favorita: false },
    { archivo: 'musica/Harry Styles - Two Ghosts.mp3', favorita: false },
    { archivo: 'musica/Conan Gray - Yours.mp3', favorita: false },
];
